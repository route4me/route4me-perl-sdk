...
has time_window_start => (is => 'rw', isa => 'Maybe[Int]');
has time_window_end => (is => 'rw', isa => 'Maybe[Int]');
has time => (is => 'rw', isa => 'Maybe[Int]');
...
has time_window_start_2 => (is => 'rw', isa => 'Maybe[Int]');
has time_window_end_2 => (is => 'rw', isa => 'Maybe[Int]');
