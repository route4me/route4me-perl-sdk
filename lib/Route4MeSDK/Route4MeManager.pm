...
use Route4MeSDK::DataTypes::QueryStringAttribute;
use Route4MeSDK::DataTypes::Metric;
use Route4MeSDK::DataTypes::OptimizationState;
use Route4MeSDK::DataTypes::DataObjectOptimizations;
use Route4MeSDK::DataTypes::Address;
use Route4MeSDK::DataTypes::AddressNote;
use Route4MeSDK::DataTypes::RouteParameters;
use Route4MeSDK::DataTypes::AlgorithmType;
use Route4MeSDK::DataTypes::Optimize;
use Route4MeSDK::DataTypes::DistanceUnit;
use Route4MeSDK::DataTypes::DeviceType;
use Route4MeSDK::DataTypes::OptimizationParameters;
use Route4MeSDK::DataTypes::DataObject;
use Route4MeSDK::DataTypes::DataObjectRoute;
use Route4MeSDK::DataTypes::User;
use Route4MeSDK::DataTypes::Links;
use Route4MeSDK::DataTypes::GetActivitiesResponse;
use Route4MeSDK::DataTypes::GetAddressBookContactsResponse;
use Route4MeSDK::DataTypes::RemoveAddressBookContactsRequest;
use Route4MeSDK::DataTypes::Activity;
use Route4MeSDK::DataTypes::AvoidanceZone;
use Route4MeSDK::DataTypes::DuplicateRouteResponse;
use Route4MeSDK::DataTypes::DeleteRouteResponse;
use Route4MeSDK::DataTypes::TrackingHistory;
use Route4MeSDK::QueryTypes::HttpMethodType;
use Route4MeSDK::QueryTypes::ActivityParameters;
use Route4MeSDK::R4MeUtils;
use Route4MeSDK::R4MEInfrastructureSettings;
